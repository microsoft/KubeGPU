...
func AddCRFlags(s *options.ContainerRuntimeOptions, fs *pflag.FlagSet) {
...
func AddKFFlags(f *options.KubeletFlags, fs *pflag.FlagSet) {
	AddCRFlags(&f.ContainerRuntimeOptions, fs)
...
func AddCfgFlags(c *componentconfig.KubeletConfiguration, fs *pflag.FlagSet) {
...
func AddFlags(s *options.KubeletServer, fs *pflag.FlagSet) {
	AddKFFlags(&s.KubeletFlags, fs)
	AddCfgFlags(&s.KubeletConfiguration, fs)
}
