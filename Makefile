...
nvidiagpuplugin:
	go build --buildmode=plugin -o ${BUILD_DIR}/nvidiagpuplugin.so ./plugins/nvidiagpuplugin/plugin/nvidiagpu.go

.PHONY: gpuschedulerplugin
gpuschedulerplugin:
	go build --buildmode=plugin -o ${BUILD_DIR}/gpuschedulerplugin.so ./plugins/gpuschedulerplugin/plugin/gpuscheduler.go
